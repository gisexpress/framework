...
namespace System.IO.Compression
{
    internal sealed class DeflateManager
    {
        ...
        private void _InitializeTreeData()
        {
            ...
            treeLiterals.staticTree = DeflateTree.Literals;

            treeDistances.dyn_tree = dyn_dtree;
            treeDistances.staticTree = DeflateTree.Distances;

            treeBitLengths.dyn_tree = bl_tree;
            treeBitLengths.staticTree = DeflateTree.BitLengths;
        ...
        internal void _tr_align()
        {
            ...
            send_code(END_BLOCK, DeflateTree.lengthAndLiteralsTreeCodes);
        ...
        internal void _tr_flush_block(int buf, int stored_len, bool eof)
        {
            ...
            else if (static_lenb == opt_lenb)
            {
                ...
                send_compressed_block(DeflateTree.lengthAndLiteralsTreeCodes, DeflateTree.distTreeCodes);
            }
            else
            {
        ...
        internal int Deflate(FlushType flush)
        {
            ...
            if (_codec.OutputBuffer.IsNull() || (_codec.InputBuffer.IsNull() && _codec.AvailableBytesIn != 0) || (status == FINISH_STATE && flush != FlushType.Finish))
            {
