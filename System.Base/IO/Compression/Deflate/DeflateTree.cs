...
namespace System.IO.Compression
{
    internal sealed class DeflateTree
    {
        ...
        internal static readonly DeflateTree Literals;
        internal static readonly DeflateTree Distances;
        internal static readonly DeflateTree BitLengths;
        ...
        private DeflateTree(short[] treeCodes, int[] extraBits, int extraBase, int elems, int maxLength)
        {
        ...
        static DeflateTree()
        {
            Literals = new DeflateTree(lengthAndLiteralsTreeCodes, Tree.ExtraLengthBits, InternalConstants.LITERALS + 1, InternalConstants.L_CODES, InternalConstants.MAX_BITS);
            Distances = new DeflateTree(distTreeCodes, Tree.ExtraDistanceBits, 0, InternalConstants.D_CODES, InternalConstants.MAX_BITS);
            BitLengths = new DeflateTree(null, Tree.extra_blbits, 0, InternalConstants.BL_CODES, InternalConstants.MAX_BL_BITS);
        }
    }
}
