...
{
    internal static class CGAlgorithmsDD
    {
        /// <summary>
        ...
        public static int OrientationIndex(ICoordinate p1, ICoordinate p2, ICoordinate q)
        {
            ...
            var dx1 = DeterminantDouble.ValueOf(p2.X) - p1.X;
            var dy1 = DeterminantDouble.ValueOf(p2.Y) - p1.Y;
            var dx2 = DeterminantDouble.ValueOf(q.X) - p2.X;
            var dy2 = DeterminantDouble.ValueOf(q.Y) - p2.Y;
        ...
        /// </list>
        /// </returns>
        public static int SignOfDet2x2(DeterminantDouble x1, DeterminantDouble y1, DeterminantDouble x2, DeterminantDouble y2)
        {
            DeterminantDouble det = (x1 * y2) - (y1 * x2);
            if (det.IsZero)
                return 0;
            if (det.IsNegative)
                return -1;
        ...
        /// </list>
        /// </returns>
        private static int OrientationIndexFilter(ICoordinate pa, ICoordinate pb, ICoordinate pc)
        {
            double detsum;
        ...
        /// using DeterminantDouble arithmetic.
        ...
        /// <returns></returns>
        public static Coordinate Intersection(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
            var denom1 = (DeterminantDouble.ValueOf(q2.Y) - DeterminantDouble.ValueOf(q1.Y)) * (DeterminantDouble.ValueOf(p2.X) - DeterminantDouble.ValueOf(p1.X));
            var denom2 = (DeterminantDouble.ValueOf(q2.X) - DeterminantDouble.ValueOf(q1.X)) * (DeterminantDouble.ValueOf(p2.Y) - DeterminantDouble.ValueOf(p1.Y));
            ...
            var numx1 = (DeterminantDouble.ValueOf(q2.X) - DeterminantDouble.ValueOf(q1.X)) * (DeterminantDouble.ValueOf(p1.Y) - DeterminantDouble.ValueOf(q1.Y));
            var numx2 = (DeterminantDouble.ValueOf(q2.Y) - DeterminantDouble.ValueOf(q1.Y)) * (DeterminantDouble.ValueOf(p1.X) - DeterminantDouble.ValueOf(q1.X));
            var numx = numx1 - numx2;
            var fracP = (numx / denom)/*.ToDoubleValue()*/;

            var x = (DeterminantDouble.ValueOf(p1.X) + (DeterminantDouble.ValueOf(p2.X) - DeterminantDouble.ValueOf(p1.X)) * fracP).ToDoubleValue();

            var numy1 = (DeterminantDouble.ValueOf(p2.X) - DeterminantDouble.ValueOf(p1.X)) * (DeterminantDouble.ValueOf(p1.Y) - DeterminantDouble.ValueOf(q1.Y));
            var numy2 = (DeterminantDouble.ValueOf(p2.Y) - DeterminantDouble.ValueOf(p1.Y)) * (DeterminantDouble.ValueOf(p1.X) - DeterminantDouble.ValueOf(q1.X));
            var numy = numy1 - numy2;
            var fracQ = numy / denom;

            var y = (DeterminantDouble.ValueOf(q1.Y) + (DeterminantDouble.ValueOf(q2.Y) - DeterminantDouble.ValueOf(q1.Y)) * fracQ).ToDoubleValue();
