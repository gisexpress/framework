    ...
    internal class RobustLineIntersector : LineIntersector
    {
        public override void ComputeIntersection(ICoordinate p, ICoordinate p1, ICoordinate p2)
        {
            ...
            if (Envelope.Intersects(p1, p2, p))
            {
                if ((CGAlgorithms.OrientationIndex(p1, p2, p) == 0) && (CGAlgorithms.OrientationIndex(p2, p1, p) == 0))
                {
                    ...
                    if (p.IsEquivalent(p1) || p.IsEquivalent(p2))
                        IsProper = false;
        ...
        public override int ComputeIntersect(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
            ...
            if (Pq1 == 0 || Pq2 == 0 || Qp1 == 0 || Qp2 == 0)
            {
                 ...
                 * 
                 */
                if (p1.IsEquivalent(q1) || p1.IsEquivalent(q2))
                    IntersectionPoint[0] = p1;
                else if (p2.IsEquivalent(q1) || p2.IsEquivalent(q2))
        ...
        int ComputeCollinearIntersection(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
            ...
            if (p1q1p2 && q1p1q2)
            {
                ...
                return q1.IsEquivalent(p1) /* && !p1q2p2 && !q1p2q2 */ ? PointIntersection : CollinearIntersection;
            }
            if (p1q1p2 && q1p2q2)
            {
                IntersectionPoint[0] = q1;
                IntersectionPoint[1] = p2;
                return q1.IsEquivalent(p2) /* && !p1q2p2 && !q1p1q2 */ ? PointIntersection : CollinearIntersection;
            }
            if (p1q2p2 && q1p1q2)
            {
                IntersectionPoint[0] = q2;
                IntersectionPoint[1] = p1;
                return q2.IsEquivalent(p1) /* && !p1q1p2 && !q1p2q2 */? PointIntersection : CollinearIntersection;
            }
            if (p1q2p2 && q1p2q2)
            {
                IntersectionPoint[0] = q2;
                IntersectionPoint[1] = p2;
                return q2.IsEquivalent(p2) /* && !p1q1p2 && !q1p1q2 */ ? PointIntersection : CollinearIntersection;
            }
            return NoIntersection;
        }
        ...
        /// </summary>
        ICoordinate Intersection(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
        ...
        void CheckDD(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2, ICoordinate intPt)
        {
        ...
        ICoordinate IntersectionWithNormalization(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
        ...
        /// </summary>
        static ICoordinate SafeHCoordinateIntersection(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
            ICoordinate intPt;
            try
            {
        ...
        /// lies at the origin.
        /// </summary>
        void NormalizeToEnvCentre(Coordinate n00, Coordinate n01, Coordinate n10, Coordinate n11, Coordinate normPt)
        {
        ...
        bool IsInSegmentEnvelopes(ICoordinate intPoint)
        {
        ...
        static ICoordinate NearestEndpoint(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
            ICoordinate nearestPt = p1;
