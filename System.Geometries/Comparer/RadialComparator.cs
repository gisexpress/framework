...
{
    internal class RadialComparator : IComparer<ICoordinate>
    {
        ...
        protected readonly ICoordinate Origin;
        ...
        static int PolarCompare(ICoordinate o, ICoordinate p, ICoordinate q)
        {
            ...
            switch (LineSegment.ComputeOrientation(o, p, q))
            {
                case 1: return 1;
                case -1: return -1;
            }
