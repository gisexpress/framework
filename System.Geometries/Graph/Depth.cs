namespace System.Geometries.Graph
{
    ...
    public class Depth 
    {
        ...
        /// <returns></returns>
        public static int DepthAtLocation(Locations _location)
        {
            if (_location == Locations.Exterior) 
                return 0;

            if (_location == Locations.Interior) 
                return 1;
        ...
        /// <param name="posIndex"></param>
        /// <param name="_location"></param>
        public void Add(int geomIndex, Positions posIndex, Locations _location)
        {
            if (_location == Locations.Interior)
