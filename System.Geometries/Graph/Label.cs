...
namespace System.Geometries.Graph
{
    ...
    public class Label
    {
        ...
        public void SetLocation(int geomIndex, Positions posIndex, Locations _location)
        {
        ...
        /// <param name="geomIndex"></param>
        /// <param name="_location"></param>
        public void SetLocation(int geomIndex, Locations _location)
        {
        ...
        /// <param name="geomIndex"></param>
        /// <param name="_location"></param>
        public void SetAllLocations(int geomIndex, Locations _location)
        {
        ...
        /// <param name="geomIndex"></param>
        /// <param name="_location"></param>
        public void SetAllLocationsIfNull(int geomIndex, Locations _location)
        {
        ...
        /// </summary>
        /// <param name="_location"></param>
        public void SetAllLocationsIfNull(Locations _location)
        {
        ...
        public void Merge(Label other)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                if (elt[i] == null)
                {
                    elt[i] = new TopologyLocation(other.elt[i]);
                }
                else
                {
                    elt[i].Merge(other.elt[i]);
                }
            }
        }
