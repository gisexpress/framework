...
{
    internal class InteriorIntersectionFinder : ISegmentIntersector
    {
        ///<summary>
        ...
        private readonly List<ICoordinate> _intersections = new List<ICoordinate>();
        ...
        public IList<ICoordinate> Intersections
        {
            get
            {
                return new ReadOnlyCollection<ICoordinate>(_intersections);
            }
        }
        ...
        private static Boolean IsEndSegment(ISegmentString segStr, int index)
        {
            ...
            if (index >= segStr.Sequence.Count - 2) return true;
            return false;
        }
