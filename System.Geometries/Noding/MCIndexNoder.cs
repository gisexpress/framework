...
using System.Geometries.Index.Chain;
using System.Geometries.Index.Strtree;
...
namespace System.Geometries.Noding
{
    ...
    internal class MCIndexNoder : SinglePassNoder
    {
        ...
        {
            IList<MonotoneChain> segChains = MonotoneChainBuilder.GetChains(segStr.Sequence, segStr);
        ...
        internal class SegmentOverlapAction : MonotoneChainOverlapAction
        {
