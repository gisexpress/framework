...
namespace System.Geometries.Noding
{
    ...
    {        
        ...
        public SegmentNode(INodableSegmentString segString, ICoordinate coord, int segmentIndex, Octants segmentOctant) 
        {
            ...
            _isInterior = !coord.IsEquivalent(segString.Sequence.Get(segmentIndex));
        }


        /// <summary>
        /// Gets the <see cref="System.Geometries.Coordinate"/> giving the location of this node.
        /// </summary>
        ...
        public int CompareTo(object obj)
        {
            ...
            if (SegmentIndex > other.SegmentIndex) 
                return 1;
            if (Coord.IsEquivalent(other.Coord))
                return 0;
