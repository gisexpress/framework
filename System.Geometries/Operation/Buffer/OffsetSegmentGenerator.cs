...
namespace System.Geometries.Operation.Buffer
{
    ...
    internal class OffsetSegmentGenerator
    {
        ...
        private readonly LineSegment _offset0 = new LineSegment { P0 = Coordinate.Empty, P1 = Coordinate.Empty };
        private readonly LineSegment _offset1 = new LineSegment { P0 = Coordinate.Empty, P1 = Coordinate.Empty };
        private Positions _side = Positions.On;
        private bool _hasNarrowConcaveAngle;

        public OffsetSegmentGenerator(IBufferParameters bufParams, double distance)
        {
        ...
        public void InitSideSegments(ICoordinate s1, ICoordinate s2, Positions side)
        {
            _s1 = s1;
            _s2 = s2;
            _side = side;
        ...
        public void AddSegments(ICoordinate[] pt, bool isForward)
        {
        ...
        public void AddNextSegment(ICoordinate p, bool addStartPoint)
        {
            ...
            if (_s1.IsEquivalent(_s2)) return;
        ...
        private void AddCollinear(bool addStartPoint)
        {
            ...
            if (numInt >= 2)
            {
                ...
                if (_bufParams.JoinStyle == JoinStyle.Bevel
                    || _bufParams.JoinStyle == JoinStyle.Miter)
                {
        ...
        private void AddOutsideTurn(int orientation, bool addStartPoint)
        {
            ...
            if (_bufParams.JoinStyle == JoinStyle.Miter)
            {
        ...
        private static void ComputeOffsetSegment(LineSegment seg, Positions side, double distance, LineSegment offset)
        {
            ...
            offset.P0 = offset.P0 ?? Coordinate.Empty;
            offset.P1 = offset.P1 ?? Coordinate.Empty;

            offset.P0.SetValues(seg.P0.X - uy, seg.P0.Y + ux);
            offset.P1.SetValues(seg.P1.X - uy, seg.P1.Y + ux);
        }
        ...
        /// <param name="p0"></param>
        /// <param name="p1"></param>
        public void AddLineEndCap(ICoordinate p0, ICoordinate p1)
        {
        ...
        /// <param name="distance">The offset distance</param>
        private void AddMitreJoin(ICoordinate p, LineSegment offset0, LineSegment offset1, double distance)
        {
        ...
        /// </summary>
        public void CreateCircle(ICoordinate p)
        {
            // add start point
        ...
        /// </summary>
        public void CreateSquare(ICoordinate p)
        {
