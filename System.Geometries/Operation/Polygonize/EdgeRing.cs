    ...
    internal class EdgeRing
    {
        ...
        public static EdgeRing FindEdgeRingContaining(EdgeRing testEr, IList<EdgeRing> shellList)
        {
            ...
            foreach (var tryShell in shellList)
            {
                ...
                var tryShellEnv = tryShellRing.GetBounds();
                if (minShell != null)
                    minShellEnv = minShell.Ring.GetBounds();
                ...
                var testPt = CoordinateArrays.PointNotInList(testRing.Coordinates.ToArray(), tryShellRing.Coordinates.ToArray());
        ...
        {
            var ring = Ring;
            _isHole = CGAlgorithms.IsCCW(ring.Coordinates.ToArray());
        }
        ...
        public IPolygon Polygon
        {
            get
            {
                ...
                IPolygon poly = Factory.Create<IPolygon>(_ring, holeLR);
                return poly;
            }
        }
            ...
            get
            {
                if (_ringPts == null)
                {
                    ...
                    foreach (DirectedEdge de in _deList)
                    {
                        ...
                        AddEdge(edge.Line.Coordinates.ToArray(), de.EdgeDirection, coordList);
                    }
        ...
        public ILineString LineString
        {
            get
            {
                ICoordinate[] tempcoords = Coordinates;
                tempcoords = null;
                return Factory.Create<ILineString>(_ringPts);
            }
        }
        ...
        public ILinearRing Ring
        {
            get
            {
                ...
                try
                {
                    _ring = Factory.Create<ILinearRing>(_ringPts);
                }
                catch (Exception)
                {
                }
        ...
        public EdgeRing OuterHole
        {
            get
            {
                ...
                for (int i = 0; i < _deList.Count; i++)
                {
                    ...
                    EdgeRing adjRing = ((PolygonizeDirectedEdge)de.SymmetricEdge).Ring;
        ...
        internal void UpdateIncluded()
        {
            ...
            {
                PolygonizeDirectedEdge de = (PolygonizeDirectedEdge)_deList[i];
                EdgeRing adjShell = ((PolygonizeDirectedEdge)de.SymmetricEdge).Ring.Shell;
        ...
        public class EnvelopeComparator : IComparer<EdgeRing>
        {
            ...
            {
                return r0.Ring.GetBounds().CompareTo(r1.Ring.GetBounds());
