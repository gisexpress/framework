...
namespace System.Geometries.Operation.Relate
{
    ...
    internal class RelateComputer
    {
        ...
        public IntersectionMatrix ComputeIM()
        {
            ...
            if (!_arg[0].Geometry.GetBounds().Intersects(_arg[1].Geometry.GetBounds()))
            {
        ...
        private void ComputeProperIntersectionIM(SegmentIntersector intersector, IntersectionMatrix im)
        {
            ...
            Dimensions dimA = _arg[0].Geometry.GetDimension();
            Dimensions dimB = _arg[1].Geometry.GetDimension();
        ...
        private void LabelIsolatedNode(Node n, int targetIndex)
        {
            ...
            Locations loc = _arg[targetIndex].Geometry.Locate(n.Coordinate);
