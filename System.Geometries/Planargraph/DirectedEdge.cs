...
namespace System.Geometries.Planargraph
{
    internal class DirectedEdge : GraphComponent, IComparable
    {
        /// <summary>
        ...
        public DirectedEdge(Node from, Node to, ICoordinate directionPt, bool edgeDirection)
        {
            ...
            if (QuadrantOp.TryGetQuadrant(dx, dy, out iQuadrant))
            {
                IsValid = true;
        ...
        protected readonly int iQuadrant;
        ...
        /// direction.
        /// </summary>
        public DirectedEdge SymmetricEdge
        {
            get;
            set;
        }
        ...
        public void Write(StreamWriter outstream)
        {
            ...
            outstream.Write("  " + name + ": " + P0 + " - " + P1 + " " + iQuadrant + ":" + Angle);
        }
        ...
        {
            return "DirectedEdge: " + P0 + " - " + P1 + " " + iQuadrant + ":" + Angle;
        }
    }
}
