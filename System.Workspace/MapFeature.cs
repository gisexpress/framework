...
{
    public class MapFeature : ISpatialObject, IDisposable
    {
        public MapFeature(MapLayer layer, IFeature feature)
        {
            Layer = layer;
            Feature = feature;
        }
        ...
        public IGeometry Geometry
        {
            ...
            set { Feature.SetGeometry(GeometryValue = value); }
        }
